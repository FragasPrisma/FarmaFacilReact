...
export function ConvenioEditComplemento({ convenioModel, nomeVisitador }: IData) {
    ...
    const [bloqueado, setBloqueado] = useState(convenioModel.bloqueado);
    const [permitirParcelamento, setPermitirParcelamento] = useState(convenioModel.permitirParcelamento);
    const [enviarEcommerce, setEnviarEcommerce] = useState(convenioModel.enviarEcommerce);
    const [permitirRateio, setPermitirRateio] = useState(convenioModel.permitirRateio);
    const [visitadorId, setVisitadorId] = useState(convenioModel.visitadorId);
    const [etiquetaId, setEtiquetaId] = useState(convenioModel.etiquetaId);
    ...
    conveniosGruposModelExcluir = conveniosGruposExcluir;
    ...
    function ExcluirGrupo(index: number) {
        ...
        setConveniosGruposExcluir([...conveniosGruposExcluir])
