...
import { ButtonCancel } from './../../../Components/Buttons/ButtonCancel/index';
...
export function EmpresaDetails() {
    ...
    const [error, setError] = useState({ erro: false, index: 0, erroNome: "" })
    ...
    return (
        <>
            <HeaderMainContent title="Visualizar Empresa" IncludeButton={false} ReturnButton={true} to="empresa" />
