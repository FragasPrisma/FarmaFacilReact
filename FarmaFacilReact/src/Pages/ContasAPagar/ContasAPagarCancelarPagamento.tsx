...
export function ContasAPagarCancelarPagamento() {
    ...
    return (
        <>
            <HeaderMainContent title="CANCELAR PAGAMENTO DA DUPLICATA" IncludeButton={false} ReturnButton={false} />
            ...
            <SuccessModal show={isOpenSuccess} textCustom="Pagamento cancelado com " />
